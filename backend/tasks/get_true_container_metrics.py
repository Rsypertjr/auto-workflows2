...
class TrueContainerMetrics(BaseModel):
    memory_usage_percent: float = Field(..., description="Memory usage Percentage of this container")
    memory_used_gb: float = Field(..., description="Memory used in Gigabytes of this container")
